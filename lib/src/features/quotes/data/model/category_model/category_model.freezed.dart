...
mixin _$CategoryModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, categoryName, slug);

  @override
  String toString() {
    return 'CategoryModel(id: $id, categoryName: $categoryName, slug: $slug)';
  }
}
...
extension CategoryModelPatterns on CategoryModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int? id,
            @JsonKey(name: 'category_name') String? categoryName, String? slug)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CategoryModel() when $default != null:
        return $default(_that.id, _that.categoryName, _that.slug);
      case _:
        return orElse();
    }
  }
...
class _CategoryModel implements CategoryModel {
  _CategoryModel(
      {this.id, @JsonKey(name: 'category_name') this.categoryName, this.slug});
